...
/* ============================================================================
   ...
   - Un solo botón en la toolbar abre un popover con:
     * selector de vistas
     * acciones Aplicar / Eliminar
     * input "Guardar como" + Guardar
   - Por qué: reduce ruido visual, evita prompts/alerts y mantiene jerarquía.
============================================================================ */
    ...
    <div className="fv" ref={ref}>
      ...
      {open && (
        <div className="fv-pop" role="dialog" aria-label="Vistas guardadas">
          ...
          <p className="fv-note">
            Las vistas se guardan en este navegador. Podemos sincronizarlas en
            backend más adelante si necesitás compartirlas.
          </p>
        </div>
      )}
    </div>
